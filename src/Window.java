public class Window {
    ...
    public String toString(){
        return "Naslov: " + getNaslov() + " oznaka: " + getOznaka() + " status:" + isJelAktivan() + " gornji lijevi kut: " + getX1() + ", " + getY1() + " donji desni kut: " + getX2() + ", " + getY2();
    }
    ...
    public static void checkCoordinates(int x1, int y1, int x2, int y2) {
        if (x1 < 0 || y1 < 0 || x2 < 0 || y2 < 0) {
            throw new IllegalArgumentException("Koordinate ne mogu biti negativne!");
        }

        System.out.println("Koordinate su valjane: (" + x1 + ", " + y1 + "), (" + x2 + ", " + y2 + ")");
